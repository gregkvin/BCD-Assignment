...
public class Admin_Manage extends javax.swing.JFrame {
    ...
    public Admin_Manage() throws IOException {
        initComponents();
        loadtable();
        setResizable(false);
    ...
    private void loadtable() throws IOException{
        ...
        DefaultTableModel model = (DefaultTableModel)(adminn.getModel());
        model.setRowCount(0);
        try {
            String[] id = ar.readID(path);
            String[] name = ar.readName(path); 
            String [] gender = ar.readGender(path);
            String[] dob = ar.readDOB(path);
            String[] email = ar.readEmail(path);
            String[] uname = ar.readUsernameWODecryption(path);
            String[] pwd = ar.readPasswordWODecryption(path);
            while(n < line){
                model.addRow(new Object[]{id[n], name[n], gender[n], dob[n], email[n], uname[n], pwd[n]});
                n=n+1;
            }
            adminn.setModel(model);
        } catch (Exception e){
    ...
    private void initComponents() {
        ...
        adminn.setFont(new java.awt.Font("Poppins", 0, 12)); // NOI18N
        adminn.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
            ...
            new String [] {
                "Admin ID", "Admin Name", "Gender", "DOB", "Email", "Username", "Password"
            }
        ) {
        ...
        jScrollPane1.setViewportView(adminn);
...
//        }
    ...
    private javax.swing.JTable adminn;
