 ...
 */
public class View_Certificates extends javax.swing.JFrame {
    ...
    public View_Certificates(User user) throws IOException {
        initComponents();
        this.user = user;
        loadtable(user);
        setResizable(false);
    ...
    private void initComponents() {
        ...
        date1.setText("View Your Certificate!");
...
//        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(View_Certificates.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                String user1 = null;
                try {
                    new View_Certificates().setVisible(true);
                } catch (IOException ex) {
                    Logger.getLogger(View_Certificates.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
