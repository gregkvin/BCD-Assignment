...
public class User_Password extends javax.swing.JFrame {
    ...
    public User_Password(User user) throws IOException {
        initComponents();
        this.user = user;
        loadtable();
        setResizable(false);
